...
def get_face_dataloader(batch_size, data_dir='', folder='', fm='arcface', num_workers=4, level=4, size=128):
    if folder == 'data_small':
        ...
        mfr2 = os.path.join(filedir, 'mfr2_img_list.txt')
        ...
        face_dataset = {
            ...
            'mfr2':FaceDataset(mfr2, data_dir=data_dir, fm=fm, level=level, size=size, resize=True),

        }

        data_list = ['lfw',  'lfw128', 'lfw128_1680', 'lfw128_masked', 'lfw128_glass', 'lfw128_crop', 'lfw96_mask', 'lfw96_glass', 'lfw96_crop','mfr2']
