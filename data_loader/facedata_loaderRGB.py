    ...
    def __getitem__(self, idx):
        ...
        if self.fm == 'arcface':
            ...
            if self.resize:
                ...
                if idx == 0:
                    print("img with idx 0")
                    print(img.shape)
                    print(type(img))
                    cv2.imwrite('my_image.jpg', img)
                    #img_uint8 = cv2.convertScaleAbs(img * 255)
                    #cv2.imwrite('testeImg.jpg', img)
...
def get_face_dataloaderRGB(batch_size, data_dir='', folder='', fm='arcface', num_workers=4, level=4, size=128):
    print("getting face dataloaderRGB")
    print("getting face dataloaderRGB")
    print("getting face dataloaderRGB")
    print("getting face dataloaderRGB")
    print("getting face dataloaderRGB")
