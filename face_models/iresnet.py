...
class IResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #print("embedding_16", embedding_16.shape)
        #print("embedding_88", embedding_88.shape)
        #print("embedding_44", embedding_44.shape)
        #print("adpt_pooling_44", adpt_pooling_44.shape)
        #print("adpt_pooling_88", adpt_pooling_88.shape)
        #print("adpt_pooling_16", adpt_pooling_16.shape)
        #print("fea", x.shape)
